...
<script type="text/javascript">
	...
	function bindDatagrid() {
		...
		datagrid = $('#dg').datagrid({
							...
							url : '<%=path %>/aidgold/selectCard' + searchCodition,
							loadMsg : '正在加载信息，请稍等......',
							...
							columns : [ [
					{ field: '', checkbox: 'true' },
					{ field: 'master', title: '卡主', width: 100,  align: 'center'},
					{ field: 'cardno', title: '卡号', width: 240,  align: 'center',formatter : formatCardno},
					{ field: 'bank', title: '所属银行', width: 100,  align: 'center'},
                    { field: 'ischeck', title: '验证', width: 80, align: 'center',formatter : formatIscheck},
							] ],
						});
					//设置分页控件 
	...
	function formatCardno(val){
		var abtn = "<a href='http://www.guabu.com/bank?cardid="+val+"' target='_blank' style='display:inline-block; width:60%; color:blue;'>"+val+"</a>";
		return abtn;
	}
