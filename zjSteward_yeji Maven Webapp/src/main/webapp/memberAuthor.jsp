	...
	<form  id="form1">
		...
		<div style="display:none;">
			<div id="toolbar">
				...
				<input type="text" class="condition" id="sname" placeholder="用户姓名" />&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	function bindDatagrid() {
		...
		searchCodition = "?regTimeFrom="+regTimeFrom+"&regTimeTo="+regTimeTo+"&sname="+sname+"&mobile="+mobile;
		datagrid = $('#dg').datagrid({
							...
							url : '<%=path %>/memberAuthor/selectList' + searchCodition,
							loadMsg : '正在加载信息，请稍等......',
                    ...
                    { field: 'sname', title: '用户姓名', width: 100,  align: 'center'},
					{ field: 'idno', title: '身份证号码', width: 180, align: 'center'},
					{ field: 'mobile', title: '手机号', width: 140,  align: 'center'},
					{ field: 'customerId', title: '客户编号', width: 360,  align: 'center'},
					{ field: 'address', title: '详细地址', width: 260,  align: 'center'},
					{ field: 'zipCode', title: '邮政编号', width: 180,  align: 'center'},
