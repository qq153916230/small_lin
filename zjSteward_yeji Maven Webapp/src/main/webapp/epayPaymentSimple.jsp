...
<script type="text/javascript">
	...
	function bindDatagrid() {
		...
		datagrid = $('#dg').datagrid({
							...
							columns : [ [
					{ field: '', checkbox: 'true' },
                    { field: 'status', title: '状态', width: 100, align: 'center',formatter : formatStatusEP},
					{ field: 'ptype', title: '类型', width: 140, align: 'center',formatter : formatPtype},
					{ field: 'tid', title: 'tid', hidden:'true'},
                    { field: 'mid', title: '用户编号', width: 120,  align: 'center'},
					{ field: 'orderid', title: '订单编号', width: 200,  align: 'center'},
                    { field: 'amount', title: '还款金额', width: 100,  align: 'center',formatter :formatprice},
					{ field: 'mobile', title: '手机', width: 180,  align: 'center'},
					{ field: 'idno', title: '身份证', width: 260,  align: 'center'},
					{ field: 'acctno', title: '借记卡卡号', width: 240,  align: 'center'},
					{ field: 'acctname', title: '开户名', width: 120,  align: 'center'},
					{ field: 'acctbankname', title: '银行', width: 120,  align: 'center'},
					{ field: 'skdate', title: '收款日期', width: 200,  align: 'center',formatter : formatTime},
	...
	function formatPtype(val){
		switch(val){
			case 1: return "代扣手续费"; break;
			case 2: return "代扣贷款金额"; break;
		}}
	//格式化状态
