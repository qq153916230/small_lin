...
<script type="text/javascript">
	...
	function bindDatagrid() {
		...
		searchCodition = "?regTimeFrom="+regTimeFrom+"&regTimeTo="+regTimeTo+"&possn="+possn;
		...
		datagrid = $('#dg').datagrid({
							...
							url : '<%=path %>/common/pos/subsidy/list' + searchCodition,
							loadMsg : '正在加载信息，请稍等......',
                    ...
                    { field: 'isdabiao', title: '状态', width: 80, align: 'center',formatter : formatStatus},
					{ field: 'dabiaodate', title: '激活日期', width: 150,  align: 'center',formatter : formatTime},
                   /*  
