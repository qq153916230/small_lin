    ...
    datagrid = $('#dg').datagrid({
        ...
        columns: [[
            ...
            },
            {
             ...
             {
                 field: 'remark', title: '备注', width: 800, align: 'left', sortable: 'true',
                 editor: { type: 'validatebox', options: { required: true } }
             }
        ...
        rownumbers: true,//行数 
        toolbar: [{
            text: '添加(Insert)', iconCls: 'icon-add', handler: Adds
        }, '-',
{
...
{
    text: '取消编辑(Esc)', iconCls: 'icon-redo', handler: Cancel
}, '-',{
    text: '通用SQL查询', iconCls: 'icon-redo', handler: SQLQuery
}
...
function SQLQuery() {
    parent.location.href = 'http://zjgj.fjlcjt.com:8088/query/WebQuery.aspx';
}
