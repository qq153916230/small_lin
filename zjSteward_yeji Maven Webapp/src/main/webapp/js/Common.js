...
function load(showmsg) {
    ...
    $("<div class=\"datagrid-mask-msg\"></div>").html("" + showmsg + "").appendTo("body").css({ display: "block", left: ($(document.body).outerWidth(true) - 190) / 2, top: ($(window).height() - 45) / 2 });
}
