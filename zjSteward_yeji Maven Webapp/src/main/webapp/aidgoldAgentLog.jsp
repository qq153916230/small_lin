...
<script type="text/javascript">
	...
	function bindDatagrid() {
		...
		datagrid = $('#dg').datagrid({
							...
							url : '<%=path %>/aidgoldAgentLog/selectList' + searchCodition,
							loadMsg : '正在加载信息，请稍等......',
							...
							columns : [ [
					{ field: '', checkbox: 'true' },
					{ field: 'tid', title: 'tid', width: 80,  align: 'center', hidden:'true'},
                    { field: 'manager', title: '操作人员', width: 120,  align: 'center'},
                    { field: 'mid', title: '用户编号', width: 80,  align: 'center'},
                    { field: 'stype', title: '类型', width: 140,  align: 'center', hidden:'true'},
                    { field: 'cont', title: '详情', width: 300,  align: 'left'},
