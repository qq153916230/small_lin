...
public class Tradedata {
    ...
    public void setModo(String modo) {
        this.modo = modo == null ? null : modo.trim();
    }
	...
	public String toString() {
		return "Tradedata [sid=" + sid + ", merchantcode=" + merchantcode
				+ ", merchantname=" + merchantname + ", skcard=" + skcard
				+ ", skbank=" + skbank + ", paymoney=" + paymoney
				+ ", paydate=" + paydate + ", paytimes=" + paytimes
				+ ", result=" + result + ", shrate=" + shrate + ", txrate="
				+ txrate + ", handcharge=" + handcharge + ", jsprice="
				+ jsprice + ", agent=" + agent + ", posno=" + posno
				+ ", possn=" + possn + ", cardno=" + cardno + ", isreward="
				+ isreward + ", ischeck=" + ischeck + ", modo=" + modo
				+ ", gdate=" + gdate + "]";
	}
